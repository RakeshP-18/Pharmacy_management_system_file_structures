 ...
 *   By Rakesh P,LP Sanjay,Hemanth kumar
 */
...
void pharmacyManagementSystem::userSelection()
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            if (!(strcmp((userName.c_str()), ("aaa"))) && (passWord == "12345") || !(strcmp((userName.c_str()), ("Prathiksha Kamath"))) && !(strcmp((passWord.c_str()), ("54321"))))
            {
                cout << "\n******Access Granted******\n"
                     << endl;
                sleep(3);
...
int main(void)
{
    ...
    Type("||\tBy : \t\t\t\t\t||\n");
    Type("||\tRakesh P 1CG20IS034 \t\t\t||\n");
    Type("||\tL P Sanjay 1CG20IS023 \t\t\t||\n");
    Type("--------------------------------------------------\n");
    sleep(2);
    system("CLS");
